...
<script type="application/javascript">
  ...
  var allowedProductIds = ['12345', '67890', '23456']; // <- Replace these with your specific product numbers
  ...
  function checkAndDisplayButton() {
    var productId = 'custom-product-id'; // <- Replace this with the mechanism to obtain the current product ID
